...
# ╔═╡ 03c70896-55b5-11ee-3310-93ec9afd7667
using AWS

# ╔═╡ ecda4d69-a014-418a-bec3-cbd2ec0c6a9b
md"""
# Julia - AWS Sample Codes

Install AWS.jl package in julia as below
...
# ╔═╡ a05b86ce-f343-423a-b334-aec4f17012bc
md"""
### import aws package
"""

# ╔═╡ 5f23b5a9-b8a9-4366-ad20-86dc4b856928
md"""
## Initialise AWS
NOTE: if you haven't set up environment variable, you can assign directly
"""

# ╔═╡ 7dec1695-6006-4327-a632-a9c1f9caa7f3
aws_access_key_id = get(ENV,"AWS_ACCESS_KEY_ID","")

# ╔═╡ 601a4f55-1619-41f5-9700-d24b06280f2c
aws_secret_access_key = get(ENV, "AWS_SECRET_ACCESS_KEY","")

# ╔═╡ e8501be1-5946-4f75-b260-fd295906539c
aws_region = get(ENV,"AWS_DEFAULT_REGION","us-east-1")

# ╔═╡ 55b9b55d-d9a8-40b6-adf3-73e15465375b
md"""
### Set up a gloabl variable to store AWS Configuration
"""

# ╔═╡ 4349b9fe-c68f-46b2-a69c-f5dc0caf740f
const AWS_GLOBAL_CONFIG = Ref{AWS.AWSConfig}()

# ╔═╡ 649fae3c-333c-4165-a787-0a93a91d2c6a
begin
...
# ╔═╡ 57b37289-ec4d-4f89-bb9f-b3e9e71c7efa
md"""
## S3

Using AWS.jl, we can interact with s3 buckets
"""

# ╔═╡ 44cd6770-b4e7-4bd4-8b9d-e1cecabef024
md"""
#### Set service as S3

"""

# ╔═╡ beca9910-7c60-4199-a3ad-ecec1bda6276
@service S3

# ╔═╡ 7de730d0-eef9-493d-b53f-408b871c8379
md"""
### List keys
"""

# ╔═╡ f38ca9b0-0de6-4ef9-9f27-955686c431ed
begin
	bucket_name = "ezygotestbucket"
	data = S3.list_objects(bucket_name; aws_config=AWS_GLOBAL_CONFIG[])
	print(data["Contents"])
end
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "fccafb6a8c418b565841e1596a439e42612260f2"
